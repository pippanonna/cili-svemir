...
lang = ".exe";     # language that you have written in

test_var = tk.StringVar(window, "./lab3/primjeri");                # folder that contains .in and .out files in itself or its subfolders

exe_var  = tk.StringVar(window, "./lab3/labos3check.exe");        # path to your COMPILED executable (or source if .py or others)
